                    ...
                    <form class="form-horizontal form-label-left" method="post">
                        <div id="step-1">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <select class="form-control" name="selDocument">
                                        ...
                                        <option value="<?php echo $doc['idTypeDocument']; ?>">
                                            <?php echo $doc['Description']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="document" name="txtDocument" required="required"
                        ...
                        <div id="step-2">
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="">Names <span
                                        class="required">*</span></label>
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="names" required="required" class="form-control"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input id="lastName" class="form-control col" type="text" name="txtLastNames"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input id="address" class="form-control col" type="text" name="txtUsername"
                        ...
                        <div id="step-3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input id="email" class="form-control col" type="email" name="txtEmail"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input id="phone" class="form-control col" type="text" name="txtPhone"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input id="address" class="form-control col" type="text" name="txtAddress"
                        ...
                        <div id="step-4">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <div id="gender" class="btn-group" data-toggle="buttons">
                                        <label class="btn btn-secondary"
                                            style="background-color: greenYellow; color: grey;"
                                            data-toggle-class="btn-primary" data-toggle-passive-class="btn-secondary">
                                            <input type="radio" name="txtGender" value="male" class="join-btn"> &nbsp;
                                            Male &nbsp;</label>
                                        <label class="btn btn-primary" data-toggle-class="btn-primary"
                                            style="background-color: pink; color: green;"
                                            data-toggle-passive-class="btn-secondary">
                                            <input type="radio" name="txtGender" value="female" class="join-btn"> &nbsp;
                                            Female &nbsp;</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-md-3 col-sm-3 label-align">Date Of Birth <span
                                        class="required">*</span></label>
                                <div class="col-md-6 col-sm-6 ">
                                    <input id="birthDate" class="date-picker form-control" required="required"
                                        type="date" name="txtBirthDate" placeholder="Selecciona fecha de nacimiento">
                                </div>
                            </div>
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <select class="form-control" name="selRol">
                                        ...
                                        <option value="<?php echo $rol['idRol']; ?>">
                                            <?php echo $rol['rolDescription']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
