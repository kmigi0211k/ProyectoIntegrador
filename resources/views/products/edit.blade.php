                    ...
                    <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.01" name="price" class="form-control @error('price') is-invalid @enderror" value="{{ old('price', $product->price) }}" placeholder="Ej: 50000">
                                <div class="form-text small">Escribe el número sin puntos de mil (Ej: 50000 para cincuenta mil).</div>
                                @error('price')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="hours_required" min="1" max="200"
                                ...
                                value="{{ old('hours_required', $product->hours_required ?? 4) }}" placeholder="Ej: 8">
                            <div class="form-text small">Cuántas horas de servicio comunitario debe comprometer el usuario para obtener este producto.</div>
