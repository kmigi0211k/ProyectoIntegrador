...
<html lang="en">
  <head>
	...
	<link rel="icon" href="<?php echo URL;?>admin/images/favicon.ico" type="image/ico" />
    ...
    <script src="<?php echo URL; ?>js/editCompra.js"></script>
  </head>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-home"></i> <span>PRODUCTS PRO</span></a>
            </div>
            ...
            <div class="profile clearfix">
              ...
              <img src="<?php echo URL; ?>admin/production/images/img.jpg" alt="" class="img-circle profile_img">              </div>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> users Management<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo URL; ?>userController/viewUsers">View Users</a></li>
                      <li><a href="<?php echo URL; ?>userController/registerUser">Register User</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i> Gestionar Productos <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo URL; ?>ProductosController/viewProducts">Ver Productos</a></li>
                      <li><a href="<?php echo URL; ?>ProductosController/registerProduct">Registrar Productos</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-desktop"></i> Gestionar Compras <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo URL; ?>ComprasController/viewCompras">Ver Compras</a></li>
                      <li><a href="<?php echo URL; ?>ComprasController/registerCompras">Registrar compras</a></li>
                    </ul>
                  </li>
              </div>
              <div class="menu_section">
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                  <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="<?php echo URL;?>admin/images/img.jpg" alt="">
                  </a>
                  ...
                  <ul class="dropdown-menu list-unstyled msg_list" role="menu" aria-labelledby="navbarDropdown1">
                    <li class="nav-item">
                      <a class="dropdown-item">
                        <span class="image"><img src="<?php echo URL;?>admin/images/img.jpg" alt="Profile Image" /></span>
                        <span>
