...
class VolunteerController extends Controller
{
    public function store(Request $request, Product $product)
    {
        ...
        $mensaje = "¡Hola! Soy {$userName}. Acabo de registrarme para un voluntariado de {$request->hours_committed} horas haciendo '{$request->help_type}' a cambio de: *{$product->name}*.";
